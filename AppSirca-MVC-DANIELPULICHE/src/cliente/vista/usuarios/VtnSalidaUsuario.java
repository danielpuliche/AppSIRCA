...
public class VtnSalidaUsuario extends javax.swing.JFrame {

    private cliente objCliente;
    
    public VtnSalidaUsuario(cliente objCliente) {
    ...
    private void initComponents() {
        ...
        jPanelInteriorPrincipal.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 25, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 25, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 25, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 105, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 105, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 105, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 185, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 185, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 185, 60, 60));
        ...
        jPanelInteriorPrincipal.add(jButton0, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 267, -1, 60));
        ...
        jTextFieldCodigo.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 24)); // NOI18N
        jTextFieldCodigo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        PanelPrincipal.add(jTextFieldCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(357, 168, 302, 60));

        jButtonSalir.setBackground(new java.awt.Color(204, 0, 0));
        jButtonSalir.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 30)); // NOI18N
        ...
        PanelPrincipal.add(jButtonSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(429, 268, 159, 55));
    ...
    private void jButtonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalirActionPerformed
        ...
        if(!cantidadCaracteres && !caracteresValidos && !campoVacio){
            try {
                ...
                objPeticion.setAccion("salidaUsuario");
                ...
                ClsRegistroDTO objRegistroDTO = new ClsRegistroDTO(fecha.format(fechaHora), hora.format(fechaHora), 2);
                ...
                switch (objResultado.getCodigoResultado()) {
                    case 1:
                        Utilidades.mensajeExito("Salida concedida, continua", "Salida concedida");
                        break;
                    case -2:
                        Utilidades.mensajeAdvertencia("Error al acceder a los registros", "Salida Denegada");
                        break;
                    case -1:
                        Utilidades.mensajeAdvertencia("Violación de seguridad", "Salida Denegada");
                        break;
                    case -3:
                        Utilidades.mensajeError("Código no registrado, por favor contacte\ncon el administrador de la aplicación", "Salida Denegado");
                        break;
                    default:
                        break;
                }
